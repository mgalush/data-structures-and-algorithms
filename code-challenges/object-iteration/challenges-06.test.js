...
// does not work - Nicholas made a stretch goal 
const templatingWithMustache = () => {
  let arr = [];
  const template = $.html();
  characters.forEach( (value) => {
    Mustache.render(template, {name : value.name});
    Mustache.render(template, {spouse : value.spouse});
    // Mustache.render(template, {spouse : value.children});
    Mustache.render(template, {house : value.house});
...
// if (arr.forEach(character.children)) {
//   return true; 
// } else {
//   return true;
// }
...
const hasChildrenValues = (arr, character) => {
  arr.forEach(value => {
    if (Object.values(value.children).includes(character)) {
...
//   if (value.children.includes(character)) {
//     console.log(true);
//     return true;
//   } else {
//     console.log(false);
